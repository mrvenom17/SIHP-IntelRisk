...
class CheckerA:
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.event_type_similarity_threshold = config.get("event_type_similarity_threshold", 75)  # was 85
        self.location_similarity_threshold = config.get("location_similarity_threshold", 75)      # was 80
        self.description_similarity_threshold = config.get("description_similarity_threshold", 70) # was 85
        self.time_window_seconds = config.get("time_window_seconds", 3600)
