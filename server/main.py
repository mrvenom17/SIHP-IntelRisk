#!/usr/bin/env python3
"""
SIEM Server - Main API Server
Receives requests and forwards them to the complete pipeline
"""
...
from src.extractor.extractor_fixed import ExtractorA
...
app = FastAPI(
    title="SIEM Server",
    description="Central Security Hub for Monitoring & Compliance",
    version="1.0.0"
)
...
async def startup_event():
    ...
    logger.info("🚀 Starting SIEM Server...")
...
async def root():
    ...
    return {
        "status": "healthy",
        "message": "SIEM Server is running",
        "version": "1.0.0"
    }
